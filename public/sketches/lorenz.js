export default function sketch(p) {
  let sigma1 = p.random(10, 20),
    rho1 = p.random(25, 35),
    beta1 = p.random(2, 3);
  let sigma2 = p.random(5, 15),
    rho2 = p.random(28, 38),
    beta2 = p.random(1, 2);

  // Randomizing initial conditions for both visualizations
  let x1 = p.random(-0.1, 0.1),
    y1 = p.random(-0.1, 0.1),
    z1 = p.random(-0.1, 0.1);
  let x2 = p.random(-0.1, 0.1),
    y2 = p.random(-0.1, 0.1),
    z2 = p.random(-0.1, 0.1);
  ...
  p.draw = function() {
    ...
    for (let i = 0; i < 10; i++) {
      // Increase the number of samples per frame
